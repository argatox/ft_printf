...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/02/28 13:10:39 by gauffret          #+#    #+#             */
/*   Updated: 2017/02/28 13:10:39 by gauffret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*conv_val(char *c_base, int base, intmax_t value, char *char_value)
{
	int			i;
	char		*str;
	intmax_t	reste;
